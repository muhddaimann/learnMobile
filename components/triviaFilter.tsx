    ...
    <View style={styles.container}>
      ...
      <View style={styles.selectorContainer}>
        <DropDownPicker
          ...
          dropDownContainerStyle={[styles.dropdownContainer, { backgroundColor: colors.surface } ]}
        />
        <DropDownPicker
          open={openCategory}
      ...
      <TouchableOpacity
        style={[
          styles.button,
          { backgroundColor: selectedDifficulty && selectedCategory ? colors.primary : colors.outline }
        ]}
        onPress={() => {
        ...
        activeOpacity={0.8}
      >
        <Text style={[styles.buttonText, { color: colors.onPrimary }]}>Generate Quiz</Text>
      </TouchableOpacity>
    </View>
  );
}
